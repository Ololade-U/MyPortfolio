...
const Experience = () => {
  return (
    <>
      <Heading size={{ mdTo2xl: "4xl", mdDown: "3xl" }} m={{mdTo2xl : '7rem 0 4rem 0'}} textAlign={"center"}>
        Experience
      </Heading>
      <Box display={"flex"} p={"0 0 0 2.5rem"} mb={'3rem'} hideFrom={"md"}>
      ...
      <Box display={'flex'} justifyContent={'center'} hideBelow={'md'} mb={'3rem'}>
        <Stack w={'50%'} textAlign={'right'} justifyContent={'space-between'} pt={'2rem'} px={{lgTo2xl : '10rem 2rem', lgDown : '6rem 2rem'}} >
            <Box>
              <Heading color={{_light :"blue"}} fontSize={"2xl"}>
                Aptech Education
              </Heading>
        ...
        <Stack w={'50%'} gap={{xlTo2xl : '5rem', xlDown : '3rem'}}  pt={'1rem'}px={{lgTo2xl : '2rem 10rem', lgDown : '2rem 6rem'}}>
            <Box>
              Aptech Education is a multinational education-based organization
              that provides expert IT training and real-world skills to students
              accross the globe. Delivered Python, html, css and react lectures
